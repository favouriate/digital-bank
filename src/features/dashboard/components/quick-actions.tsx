...
const tileClassName =
  "flex min-h-11 w-full flex-col items-center justify-center gap-1.5 rounded-xl bg-balance-foreground/15 px-1 py-3 text-balance-foreground transition-colors hover:bg-balance-foreground/25 focus-visible:ring-balance-foreground/80 focus-visible:ring-offset-0 lg:py-2";
